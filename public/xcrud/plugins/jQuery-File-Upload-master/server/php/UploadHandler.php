...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $selectedId_ = $_SESSION['selectedid']; 
        $selected_path = $_SESSION['image_upload_path'];
		//$fileUrl = $this->get_full_url().'/files/'.$selectedId_.'/' ;
        $fileUrl = $this->get_full_url().'/' . $_SESSION['image_upload_path'] . "/" .$selectedId_.'/' ;
        $fileUrl_1 = dirname($this->get_server_var('SCRIPT_FILENAME')).'/' . $_SESSION['image_upload_path'] . "/" .$selectedId_.'/' ;
        //echo $fileUrl . "<br>";
        //echo $fileUrl_1  ;

        //echo dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$selectedId_.'/';
        //echo $fileUrl;
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../../../' . $selected_path .  '/'.$selectedId_.'/', 
            //'upload_dir' => $fileUrl_1,
            //'upload_url' => $fileUrl,
            'upload_url' => $this->get_full_url().'/../../../../' . $selected_path .  '/'.$selectedId_.'/',
