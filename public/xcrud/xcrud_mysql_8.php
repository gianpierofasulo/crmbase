            ...
            foreach ($fdata as $fitem)
            {
                ...
                switch ($type)
                {
                    ...
                    default:
                        ...
                        //echo "HHHH>>>" . $fitem['table']. '.' . $fitem['field'] ."<br>";
                        //print_r($attr);
                        //echo "<br>";
                        //echo "<br>NNNNN" . print_r($fitem['field']) ."-----". print_r($attr) . "<br>";
                        $this->field_attr[$fitem['table'] . '.' . $fitem['field']] = $attr;
                        break;
                }
    ...
    protected function _build_select_list($csv = false)
    {
        ...
        foreach ($this->columns as $field_index => $val)
        {
            if ($val)
            {
                ...
                {
                    $columns[] = 'CONCAT(ST_X(`' . $val['table'] . '`.`' . $val['field'] . '`),\',\',ST_Y(`' . $val['table'] . '`.`' . $val['field'] .
        ...
        if ($this->fields)
        {
            foreach ($this->fields as $key => $val)
            {
                if ($val && !isset($this->custom_fields[$key]))
                {
                    ...
                    elseif (isset($this->point_field[$key]))
                    {
                        $fields[] = 'CONCAT(ST_X(`' . $val['table'] . '`.`' . $val['field'] . '`),\',\',ST_Y(`' . $val['table'] . '`.`' . $val['field'] .
                            '`)) AS `' . $val['table'] . '.' . $val['field'] . '`' . "\r\n";
                    }
            ...
            foreach ($this->where as $key => $params)
            {
                ...
                if (!isset($params['custom']))
                {
                    ...
                    else
                    {
                        ...
                        {
                            $where_arr[] = 'CONCAT(ST_X(`' . $this->_where_field($params) . '`),\',\',ST_Y(`' . $this->_where_field($params) . '`))' . $this->
        ...
        if ($this->search && ($this->task == 'list' or $this->task == 'print' or $this->task == 'csv' or $this->after == 'list'))
        {
            ...
            if ($this->column && isset($search_columns[$this->column]))
            {
               ...
               // if relation
                ...
                elseif (isset($this->point_field[$this->column]))
                {
                    ...
                    $fitem = reset($fdata);
                    $where_arr[] = 'CONCAT(ST_X(`' . $fitem['table'] . '`.`' . $fitem['field'] . '`),\',\',ST_Y(`' . $fitem['table'] . '`.`' . $fitem['field'] .
                ...
                {       
                    ...
                    elseif (isset($this->point_field[$key]))
                    {
                        ...
                        if($value !=""){
                            ...
                            if($condition == "LIKE"){
                                $where_arr[] = 'CONCAT(ST_X(`' . $table . '`.`' . $field . '`),\',\',ST_Y(`' . $table . '`.`' . $field .
                                    ...
                                    default:
                                        ...
                                        if (isset($this->point_field[$key]))
                                        {
                                            ...
                                            if($value != ""){
                                                ...
                                                if($condition == "LIKE"){
                                                    $where_arr[] = 'CONCAT(ST_X(`' . $table . '`.`' . $field . '`),\',\',ST_Y(`' . $fitem['table'] . '`.`' . $fitem['field'] .
                                                        '`)) LIKE ' . $db->escape_like($value, $this->search_pattern);
                                                }else{
                                                    $where_arr[] = 'CONCAT(ST_X(`' . $table . '`.`' . $field . '`),\',\',ST_Y(`' . $fitem['table'] . '`.`' . $fitem['field'] .
                                                    '`)) ' . $condition . ' ' . $value;
            ...
            else
            {
                ...
                foreach ($search_columns as $key => $fitem)
                {
                    ...
                    elseif (isset($this->point_field[$key]))
                    {
                        $or_array[] = 'CONCAT(ST_X(`' . $fitem['table'] . '`.`' . $fitem['field'] . '`),\',\',ST_Y(`' . $fitem['table'] . '`.`' . $fitem['field'] .
                            '`)) LIKE ' . $db->escape_like($this->phrase, $this->search_pattern);
                    }
                    elseif (isset($this->bit_field[$key]))
                    {
