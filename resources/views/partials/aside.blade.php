<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
    <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./index.html" class="brand-link"> <!--begin::Brand Image--> <img src="images/Logo.jpg" alt="Dashboard logo" class="brand-image opacity-75 shadow">
         <span class="brand-text fw-light">LIVESCREEN</span></a>
    </div>
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ url('/prova') }}" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                <p>User</p>
                            </a> </li>
